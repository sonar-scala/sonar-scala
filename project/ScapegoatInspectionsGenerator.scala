...
object ScapegoatInspectionsGenerator {
  ...
  val generatorTask = Def.task {
    ...
    val lines = List(
      ...
      "def toRuleSeverity: String",
      "}",
      "object Level {",
      "case object Error extends Level { override def toRuleSeverity: String = Severity.MAJOR }",
      "case object Warning extends Level { override def toRuleSeverity: String = Severity.MINOR }",
      "case object Info extends Level { override def toRuleSeverity: String = Severity.INFO }",
